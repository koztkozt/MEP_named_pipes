...
const char* get_pipe_option_string(const char* pipe_arg) {
    ...
    else if (strcmp(pipe_arg, "6") == 0) {
        return "6";
    }
    else if (strcmp(pipe_arg, "7") == 0) {
        return "7";
...
const char* get_pipe_name(const char* int_string) {
    ...
    else if (strcmp(int_string, "6") == 0) {
        return pipe_names[5];
    }
    else if (strcmp(int_string, "7") == 0) {
        return pipe_names[6];
    }
    else {
        return NULL;
...
int main(int argc, const char** argv)
{
    ...
    const char* pipe_option = NULL;
    bool pipe_set = false;
    const char* server_exe = NULL;
    bool server_set = false;
    const char* client_exe = NULL;
            ...
            if (strcmp(argv[1], "--pipe") == 0) {
                ...
                if (pipe_set) {
                    ...
                    if (pipe_option_string == NULL) {
                        std::cout << "Invalid pipe type number: " << argv[2] << " (must be 1-7).\n" << endl;
                        std::cout << get_args_error_string(argc, max_args, argv) << endl;
                        std::cout << help_message() << endl;
                        return 1;
                    }
        ...
        if (argc >= 5) {
            if (strcmp(argv[3], "--pipe") == 0) {
                ...
                if (pipe_set) {
                    ...
                    if (pipe_option_string == NULL) {
                        std::cout << "Invalid pipe type number: " << argv[4] << " (must be 1-7).\n";
                        std::cout << get_args_error_string(argc, max_args, argv) << endl;
                        std::cout << help_message() << endl;
                        return 1;
                    }
        ...
        if (argc == 7) {
            if (strcmp(argv[5], "--pipe") == 0) {
                ...
                if (pipe_set) {
                    ...
                    if (pipe_option_string == NULL) {
                        std::cout << "Invalid pipe type number: " << argv[6] << " (must be 1-7).\n" << endl;
                        std::cout << help_message() << endl;
                        return 1;
                    }
                    else {
    ...
    std::cout << "The server will write \"*** Hello Purple Test ***\" to the pipe." << endl;
